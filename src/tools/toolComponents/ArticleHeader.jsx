...
const ArticleHeader = ({isEdit,toggleOptions,saveChanges}) => {
      ...
      <div className="main_table_header_div">
        {isEdit === false ? (
          <div className="inner-div-left-section">
            ...
            <h1 className="policy_heading">Articles</h1>
          </div>
        ) : (
          <div className="inner-div-left-section">
            <p className="inner-div-left-title">Edit The Articles</p>
